...
- [ ] T002 Initialize Python 3.11 project with FastAPI, Cohere SDK, Qdrant client, Pydantic, SQLAlchemy dependencies in requirements.txt
- [ ] T003 [P] Configure linting (ruff) and formatting tools (black) in pyproject.toml
- [ ] T004 [P] Create .env.example with environment variables from specification
- [ ] T005 [P] Create docker-compose.yml configuration file
- [ ] T006 Create main.py application entry point based on project structure
...
- [ ] T007 Setup database models and SQLAlchemy base in backend/src/models/__init__.py
- [ ] T008 [P] Create configuration management from environment variables in backend/src/core/config.py
- [ ] T009 [P] Setup security utilities and credential management in backend/src/core/security.py
- [ ] T010 Create constants module in backend/src/core/constants.py
- [ ] T011 [P] Setup dependency injection for API in backend/src/api/dependencies.py
- [ ] T012 Configure error handling infrastructure in backend/src/api/exceptions.py
- [ ] T013 [P] Create logging infrastructure in backend/src/core/logging.py
- [ ] T014 Setup Qdrant vector store connection in backend/src/core/vector_store.py
- [ ] T015 Setup Neon Postgres connection using SQLAlchemy in backend/src/core/database.py
- [ ] T016 Create API routing structure in backend/src/api/__init__.py
- [ ] T017 Create Cohere client configuration in backend/src/core/llm_client.py
...
- [ ] T020 [P] [US1] Create BookTextSegment model in backend/src/models/text_segment.py
- [ ] T021 [P] [US1] Create BookSection model in backend/src/models/book_section.py
- [ ] T022 [P] [US1] Create ConversationSession model in backend/src/models/conversation_session.py
- [ ] T023 [US1] Implement chunking service with sentence-aware logic in backend/src/services/chunking_service.py
- [ ] T024 [US1] Implement embedding service using Cohere in backend/src/services/embedding_service.py
- [ ] T025 [US1] Implement retrieval service for vector search in backend/src/services/retrieval_service.py
- [ ] T026 [US1] Implement validation service with hallucination checks in backend/src/services/validation_service.py
- [ ] T027 [US1] Implement generation service with Cohere-based answer generation in backend/src/services/generation_service.py
- [ ] T028 [US1] Implement chat endpoint with book-wide mode in backend/src/api/v1/chat.py
- [ ] T029 [US1] Implement ingestion endpoint in backend/src/api/v1/ingestion.py
- [ ] T030 [US1] Add health check endpoint in backend/src/api/v1/health.py
- [ ] T031 [US1] Configure API routing for v1 in backend/src/api/v1/__init__.py
...
- [ ] T034 [P] [US2] Enhance ConversationSession model to track mode in backend/src/models/conversation_session.py
- [ ] T035 [US2] Update retrieval service to bypass vector search in selected-text mode in backend/src/services/retrieval_service.py
- [ ] T036 [US2] Update validation service to enforce context isolation in backend/src/services/validation_service.py
- [ ] T037 [US2] Enhance generation service for selected-text context in backend/src/services/generation_service.py
- [ ] T038 [US2] Enhance chat endpoint with selected-text mode in backend/src/api/v1/chat.py
- [ ] T039 [US2] Implement strict context isolation validation in backend/tests/unit/test_validation.py
